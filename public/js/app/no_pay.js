...
// 框架
var NoPay = function (_React$Component) {
    _inherits(NoPay, _React$Component);

    function NoPay(props) {
        _classCallCheck(this, NoPay);

        var _this = _possibleConstructorReturn(this, (NoPay.__proto__ || Object.getPrototypeOf(NoPay)).call(this, props));
            ...
            if (this.props.thitem.type == "operation") {
                ...
                return React.createElement(
                    ...
                    React.createElement(
                        ...
                        React.createElement(
                            "a",
                            { href: "index?product_id=" + this.props.item.id },
                            "\u652F\u4ED8"
                        )
                    )
                );
...
;
// 返回到页面
ReactDOM.render(React.createElement(NoPay, null), document.getElementById("no_pay"));
